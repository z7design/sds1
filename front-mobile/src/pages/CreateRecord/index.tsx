...
import RNPikersSelect from 'react-native-picker-select';
import axios from 'axios';
import { RectButton } from 'react-native-gesture-handler';


const placeholder = {
    label: 'Selecion o game',
    value: null
}
...
const CreateRecord = () => {
    ...
    const [platfom, setPlatform] = useState<GamePlatform>();
    const [selectGame, setSelectedGame] = useState('');
    const [allGames, setAllGames] = useState<Game[]>([]);
    const [filteredGames, setFilteredGames] = useState<Game[]>([]);

    const handleChangePlatfom = (selectedPlatform: GamePlatform) => {
    ...
    const handleSubmit = () => {
        const payload = {name, age, gameId: setSelectedGame};
        ...
        <View style={styles.container}>
            ...
            <View style={styles.platformContainer}>
                <Platformcard platform='PC'
                    icon="laptop"
                    onChange= {handleChangePlatfom}
                    activePlatform={platfom}
                />
